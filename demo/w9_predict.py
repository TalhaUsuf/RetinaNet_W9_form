...
def get_parser():
    parser = argparse.ArgumentParser(description="detect fields on the W9 form images. Use weights corresponding to model_0012999.pth i.e. weights saved at 13000 th iteration.")
    parser.add_argument(
        "--config-file",
        default="../configs/custom.yaml",
        metavar="FILE",
        help="path to RetinaNet config file",
    )
    ...
    parser.add_argument(
        "--input",
        nargs="+",
        help="A list of space separated input W9-form images paths; "
...
if __name__ == "__main__":
    ...
    args = get_parser().parse_args() # NameSpace object
