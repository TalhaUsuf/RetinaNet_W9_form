...
from detectron.solver import WarmupParamScheduler
from detectron.solver.build import get_default_optimizer_params
from detectron.config import LazyCall as L
from detectron.model_zoo import get_config
from detectron.data.samplers import TrainingSampler, InferenceSampler
