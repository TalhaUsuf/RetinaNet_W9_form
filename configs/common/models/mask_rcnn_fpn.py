...
from detectron.modeling.backbone.fpn import LastLevelMaxPool
from detectron.modeling.backbone import BasicStem, FPN, ResNet
...
from detectron.modeling.proposal_generator import RPN, StandardRPNHead
