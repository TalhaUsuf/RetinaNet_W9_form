...
@app.post('/recognize/{fpath:path}', response_model=output_model, status_code=status.HTTP_201_CREATED)
async def recognize(fpath : str):
...
async def upload_file(fpath : UploadFile = File(...)):
    ...
    # %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    if fpath.filename.split(".")[-1] == "tiff":

        assert fpath.filename.split(".")[-1] == "tiff", f"uploaded file must be of type *.tiff"
        with open("./received.tiff", "wb") as buffer:
            shutil.copyfileobj(fpath.file, buffer)
        ...
        if suff == ".tiff":
            ...
            os.system(
                f"python demo/w9_predict.py  --config-file configs/custom.yaml  --input {string_} --output ./detections")
            ...
            #           SEE FOLLOWING:
            #           [1] “SQLModel.” https://sqlmodel.tiangolo.com/ (accessed Sep. 15, 2021).
            #           [2] M. Herman, Awesome FastAPI |. 2021. Accessed: Sep. 15, 2021. [Online]. Available: https://github.com/mjhea0/awesome-fastapi
            #
            # %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
