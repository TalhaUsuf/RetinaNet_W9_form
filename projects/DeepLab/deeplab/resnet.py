...
from detectron.layers import CNNBlockBase, Conv2d, get_norm
from detectron.modeling import BACKBONE_REGISTRY
from detectron.modeling.backbone.resnet import (
    BasicStem,
    BottleneckBlock,
